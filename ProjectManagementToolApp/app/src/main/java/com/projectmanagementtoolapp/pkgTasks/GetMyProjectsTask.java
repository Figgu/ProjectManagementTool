...
public class GetMyProjectsTask extends AsyncTask<Object, Object, String> {
    ...
    public GetMyProjectsTask(Activity activity) {
    ...
    protected void onPostExecute(String s) {
        ...
        ArrayList<Project> projects = gson.fromJson(responseStr, type);
        System.out.println(projects);

        Database db = Database.getInstance();
        db.getCurrentUser().setProjects(projects);

        ((MainActivity) activity).addList();
    }
}