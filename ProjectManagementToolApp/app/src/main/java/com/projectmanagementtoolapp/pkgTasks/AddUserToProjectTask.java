...
public class AddUserToProjectTask extends AsyncTask<Object, Object, String> {
    ...
    public AddUserToProjectTask(Activity activity) {
    ...
    protected String doInBackground(Object... params) {
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .build();
        Gson gson = new Gson();
        ArrayList<Userisinprojectwithrole> uprs = (ArrayList<Userisinprojectwithrole>) params[1];
        String requestStr = gson.toJson(uprs);
