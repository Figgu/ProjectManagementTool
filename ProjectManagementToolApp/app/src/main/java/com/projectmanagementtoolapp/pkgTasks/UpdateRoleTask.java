...
public class UpdateRoleTask extends AsyncTask<Object, Object, String> {
    ...
    public UpdateRoleTask(Activity activity) {
    ...
    protected void onPostExecute(String s) {
        ...
        ((AddRoleActivity) activity).makeSnackbarFromTask(responseStr);
    }
}
